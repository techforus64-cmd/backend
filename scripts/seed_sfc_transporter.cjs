...
async function processExcelData() {
    ...
    fs.writeFileSync('C:/Users/Abhudaya/Downloads/aeiou (5)-3/backend/scripts/sfc_transporter_config.json', JSON.stringify(resultPayload, null, 2));
    console.log("Configuration and Matrix successfully exported to backend/scripts/sfc_transporter_config.json");
